...
## Parallel agents
- If another agent (e.g. Codex) is working in this repo at the same time, work in a
  separate **git worktree** so you don't clobber each other's edits.
